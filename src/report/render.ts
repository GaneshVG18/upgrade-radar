...
const messageLabels: Record<string, string> = {
  ...
  jev_relevance_judgment_with_host_policy_v2: "Jev relevance judgment, validated by host policy v2",
  jev_negative_pair_judgment_with_host_policy_v2: "Jev negative pair judgment, validated by host policy v2",
  jev_explicit_configuration_preserves_old_behavior: "Visible configuration preserves the old behavior",
  jev_relevance_judgment_with_host_policy_v3: "Jev relevance judgment, validated by host policy v3",
  jev_negative_pair_judgment_with_host_policy_v3: "Jev negative pair judgment, validated by host policy v3",
  jev_choice_confidence_below_majority: "Jev choice confidence did not reach a majority",
